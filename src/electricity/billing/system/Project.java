...
public class Project extends JFrame implements ActionListener{
    ...
    Project(String atype,String meter){
       ...
       newcustomer.setFont(new Font("menospaced",Font.PLAIN,12));
       ...
       customerdetails.setFont(new Font("menospaced",Font.PLAIN,12));
       ...
       depositdetails.setFont(new Font("menospaced",Font.PLAIN,12));
       ...
       calculatebill.setFont(new Font("menospaced",Font.PLAIN,12));
       ...
       updateinformation.setFont(new Font("menospaced",Font.PLAIN,12));
       ...
       viewinformation.setFont(new Font("menospaced",Font.PLAIN,12));
       ...
       paybill.setFont(new Font("menospaced",Font.PLAIN,12));
       ...
       JMenuItem billdetails=new JMenuItem("Bill Details");
        billdetails.setFont(new Font("menospaced",Font.PLAIN,12));
       ...
       generatebill.setFont(new Font("menospaced",Font.PLAIN,12));
       generatebill.setBackground(Color.WHITE);
       ImageIcon icon9=new ImageIcon(ClassLoader.getSystemResource("icon/icon9.png"));
       Image image9=icon9.getImage().getScaledInstance(20,20, Image.SCALE_DEFAULT);
       generatebill.setIcon(new ImageIcon(image9));
       generatebill.setMnemonic('V');
       generatebill.addActionListener(this);
       generatebill.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_V,ActionEvent.CTRL_MASK));
       ...
       notepad.setFont(new Font("menospaced",Font.PLAIN,12));
       ...
       calculator.setFont(new Font("menospaced",Font.PLAIN,12));
       ...
       sexit.setFont(new Font("menospaced",Font.PLAIN,12));
       sexit.setBackground(Color.WHITE);
       ImageIcon icon12=new ImageIcon(ClassLoader.getSystemResource("icon/icon11.png"));
       Image image12=icon12.getImage().getScaledInstance(20,20, Image.SCALE_DEFAULT);
       sexit.setIcon(new ImageIcon(image12));
       sexit.setMnemonic('X');
       sexit.addActionListener(this);
       sexit.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_X,ActionEvent.CTRL_MASK));
       exit.add(sexit);
